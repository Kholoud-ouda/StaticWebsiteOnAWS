    ...
    "Statement": [
        {
            "Effect": "Allow",
            "Resource": [
                "arn:aws:logs:${var.region}:852943587558:log-group:/aws/codebuild/*"
            ],
            "Action": [
                "logs:CreateLogGroup",
        ...
        },
        {
            "Effect": "Allow",
            "Resource": [
                "arn:aws:codecommit:${var.region}:852943587558:${var.project}"
            ],
            "Action": [
                "codecommit:GitPull"
            ]
        },
        {
            ...
            "Resource": [
                "arn:aws:codebuild:${var.region}:852943587558:report-group/*"
            ]
        },
        {
            "Sid": "K11",
